export const showcase = [
  ...
  },
  {
    ...
    r2: '',
    alt: 'Sports channels in 4K on IPTV UK trial',
  },
  {
    label: 'Movies',
    ...
    r2: '',
    alt: 'Thousands of on-demand movies on IPTV service UK',
  },
  {
    label: 'Series',
    title: 'Binge-worthy series library',
    body: 'Full seasons, next-episode auto-play, and a watchlist that syncs across devices.',
    r2: '',
    alt: 'Binge-worthy series library on IPTV subscription UK',
  },
  {
    label: 'Kids',
  ...
  {
    label: 'EPG',
    title: '7-day EPG & recording',
    body: 'A proper electronic programme guide with catch-up and one-tap recording.',
    r2: '',
    alt: '7-day electronic programme guide and catch-up recording on IPTV service',
  },
] as const;
